...
class BinSearchTree:
    ...
    def remove(self, key):
        ...
        if node:
            ...
            # 말단노드인 경우(The simplest case of no children)
            if nChildren == 0:
                # 만약 parent 가 있으면
                ...
                # self.root 를 None 으로 하여 빈 트리로 만듭니다.
                    ...
                    self.root = None
            # 자식 하나인 경우(When the node has only one child)
            elif nChildren == 1:
                ...
                # self.root 에 위에서 가리킨 자식을 대신 넣습니다.
                    ...
                    self.root = tmp_node
            # 자식이 둘인 경우(When the node has both left and right children)
            else:
                parent = node
                ...
                ### 아래 모두 successor의 오른쪽 자식만을 가리키도록 한다.
